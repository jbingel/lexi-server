"""
Adaptation of Porter Stemmer implementation obtained from https://pypi.python.org/pypi/stemming/1.0.
Available from named URL under Public Domain license.

Implements a counter of morpheme reductions ('steps').
"""
